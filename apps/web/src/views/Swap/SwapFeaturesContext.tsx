...
const CHART_SUPPORT_CHAIN_IDS = [ChainId.BSC, ChainId.GOERLI]
const ACCESS_TOKEN_SUPPORT_CHAIN_IDS = [ChainId.BSC, ChainId.GOERLI]
const STABLE_SUPPORT_CHAIN_IDS = [ChainId.BSC_TESTNET, ChainId.BSC, ChainId.GOERLI]
